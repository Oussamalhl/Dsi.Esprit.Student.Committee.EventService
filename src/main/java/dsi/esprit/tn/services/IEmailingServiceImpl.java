...
public interface IEmailingServiceImpl {
    void ParticipationConfirmation(List<String> user, Event e, String pathPDF) throws Exception;
    String GenerateBadge(List<String> user, Event e) throws WriterException, IOException, Exception;
